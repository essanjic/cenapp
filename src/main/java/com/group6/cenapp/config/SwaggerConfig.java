...
public class SwaggerConfig implements WebMvcConfigurer {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.group6.cenapp.controller"))
                .paths(PathSelectors.any())
                .build()
                .tags(new Tag("Restaurants", "Restaurant Controller"))
                ...
                .tags(new Tag("Attributes", "Restaurant Attribute Controller"))
