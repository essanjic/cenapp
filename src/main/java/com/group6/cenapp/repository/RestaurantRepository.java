...
public interface RestaurantRepository extends JpaRepository<Restaurant, Integer>, PagingAndSortingRepository<Restaurant, Integer> {
    ...
    //Hacer una query donde se traiga los restaurantes por ciudad, rango de fecha categoria y por mesas disponibles
    ...
    //Hacer una query donde la busqueda de restaurante sea por nombre de ciudad, rango de fecha categoria, mesas disponibles, y nombre de restaurante
    ...
    List<Restaurant> getByCityAndRangeDateAndName(Integer city_id, LocalDate check_in_date, LocalDate check_out_date, String name);
